    ...
    <n-card class="calculator-card" embedded>
      <template #header>
        <div class="card-header">
          ...
          <n-text class="card-title">操場配速計算機</n-text>
        </div>
      </template>
...
import { LocationOutline as LocationIcon, Calculator as CalculatorIcon } from '@vicons/ionicons5'
import { usePaceCalculator, type PaceTime } from '../../../composables/usePaceCalculator'
import TrackInfoCard from './components/TrackInfoCard.vue'
